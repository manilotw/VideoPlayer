...
(function activateVolumeButtons() {
  ...
  (function activateProgressbar() {
    ...
    function updateVideoProgress(x) {
      ...
      let relPosition = x - $progress.offset().left;
      let percentage = 100 * relPosition / $progress.width();
      ...
      setSliderWidth(percentage);
      const seconds = durationSeconds * percentage / 100;
